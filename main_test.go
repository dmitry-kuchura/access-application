...
func testRouteNotOK(method string, t *testing.T) {
	passed := false
	router := gin.New()
	router.Handle(method, "/test_2", func(c *gin.Context) {
		passed = true
	})
...
func testRouteNotOK2(method string, t *testing.T) {
	...
	router.Handle(methodRoute, "/test", func(c *gin.Context) {
		passed = true
	})
...
func TestRouterMethod(t *testing.T) {
	router := gin.New()
	router.PUT("/hey2", func(c *gin.Context) {
		c.String(200, "sup2")
	})

	router.PUT("/hey", func(c *gin.Context) {
		c.String(200, "called")
	})

	router.PUT("/hey3", func(c *gin.Context) {
		c.String(200, "sup3")
	})
...
func TestRouteRedirectTrailingSlash(t *testing.T) {
	...
	router.POST("/path3", func(c *gin.Context) {})
	router.PUT("/path4/", func(c *gin.Context) {})
...
func TestRouteRedirectFixedPath(t *testing.T) {
	...
	router.GET("/Path2", func(c *gin.Context) {})
	router.POST("/PATH3", func(c *gin.Context) {})
	router.POST("/Path4/", func(c *gin.Context) {})
...
func TestRouteParamsByName(t *testing.T) {
	...
	wild := ""
	router := gin.New()
	router.GET("/test/:name/:last_name/*wild", func(c *gin.Context) {
